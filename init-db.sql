-- Criação do banco e usuário principal do PowerDNS
CREATE DATABASE IF NOT EXISTS powerdns CHARACTER SET utf8 COLLATE utf8_unicode_ci;
...
-- Criação de usuário do PowerDNS-Admin
